...
const PRODUCTS = [
  {
    ...
    usageInstructionsTh: "👤 แพ็กเกจใช้งานส่วนตัว 100% (359 บาท / เดือน):\nสิทธิ์การใช้งานส่วนตัวแบบ 100% ข้อมูลไม่ปะปนกับใคร ปลอดภัยสูงสุด และเชื่อมต่อกับ Codex / Advanced Coding ได้อย่างเต็มประสิทธิภาพ\n\n👥 แพ็กเกจแบบหาร หรือ แชร์ (ใช้อีเมลร้าน):\n⏳ เร็วๆ นี้ (Coming Soon)\n\n💡 คำแนะนำจากร้านค้า:\nหากต้องการใช้งานสำหรับงานส่วนตัวที่มีข้อมูลสำคัญ แนะนำเลือกแบบส่วนตัว 359 บาท/เดือน จะคุ้มค่าและปลอดภัยที่สุดครับ! ทางร้านรับประกันเรื่องความปลอดภัยสูงสุด จะไม่มีการเข้าไปยุ่งเกี่ยวใดๆ กับอีเมลส่วนตัวของลูกค้า และเรามีคู่มือและรายละเอียดในการย้ายข้อมูลเดิมให้กับลูกค้าอย่างละเอียด\n\n🔒 การรับประกันและความปลอดภัย:\nเราดูแลรับประกันตลอดอายุการใช้งาน เคลมบัญชีใหม่ให้ทันที 1 ครั้งหากเกิดปัญหาการหลุด พร้อมดูแลซัพพอร์ตช่วยเหลือตลอด 24 ชั่วโมง",
    usageInstructionsEn: "👤 Private Package 100% (359 THB / Month):\nEnjoy 100% complete privacy with your data isolated. Supports full access to Codex / Advanced Coding features.\n\n👥 Shared / Joint Package (Store Email):\n⏳ Coming Soon\n\n💡 Shop Recommendation:\nFor private work and sensitive data, we highly recommend the Single-User Private package (359 THB/Month) for maximum security. We guarantee 100% safety and will never access your account. We also provide a complete step-by-step guide to migrate your existing data.\n\n🔒 Safety & Warranty:\nComplete warranty support during the license period. Instant 1-time replacement in case of any issues with 24/7 support."
  },
  {
    id: 2,
